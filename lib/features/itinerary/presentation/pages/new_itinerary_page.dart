        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                // NOTE: disabled for now because it's kind of useless
                // Text(
...
class _ManualPreviewCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final preferenceText = visiblePreferences.isEmpty
        ...
        : [
            _travelerCountLabel(travelerCount),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: FilledButton.icon(
        ...
        label: Text(
          appText(context, isCreating ? 'CREATING' : 'CREATE TRIP'),
        ),
      ),
    );
  }
